<%@ Page Language="C#" StylesheetTheme="Edit" MasterPageFile="~/Admin/Main.master"
    AutoEventWireup="true" Inherits="Galleries_EditGalleries" Title="Galleries" CodeBehind="EditGalleries.aspx.cs" %>
                                    ...
                                    <tr>
                                        <td class="cFieldLeft2">
                                            <AKP:ExRadUpload ID="uplPicFile" jas="1" AutoSave="false" runat="server" AllowedFileExtensions=".gif,.jpg,.jpeg,.png,.bmp"
                                                TargetFolder="~/Files/Galleries/" Skin="Vista" MaxFileSize="99990000" ControlObjectsVisibility="None" />
                                            <br />
