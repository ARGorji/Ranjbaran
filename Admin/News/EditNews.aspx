                    ...
                    <div class="cEditMainData">
                                ...
                                <tr>
                                    <td class="cFieldLeft">
                                        <table class="cTblField">
                                            <tr>
                                                <td class="cCtrl">
                                                    <AKP:ExTextBox ID="txtTitle" jas="1" runat="server" />
                                                </td>
                                                <td class="cLabel">
                                ...
                                <tr>
                                    <td class="cFieldLeft">
                                        <table class="cTblField">
                                            <tr>
                                                <td class="cCtrl">
                                                    <AKP:ExCheckBox ID="chkTeletex" jas="1" runat="server" />
                                                </td>
                                                <td class="cLabel">
                                                    <asp:Label ID="Label1" runat="server" Text="اخبار انتخابی:"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                        ...
                        <div>
                            <table class="cTblField">
                                <tr>
                                    <td class="cCtrl">
                                        <AKP:ExRadEditor dir="rtl" ID="txtNewsBody" DocumentManager-MaxUploadFileSize="11000000"
                                    ...
                                    <td class="cLabel">
                                        <asp:Label ID="lblNewsBody" runat="server" Text="متن خبر:"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </div>
