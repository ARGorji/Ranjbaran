...
(function($) {
    ...
    $.fn.orbit = function(options) {
        ...
        var defaults = {  
            ...
            captionAnimationSpeed: 1500, //if so how quickly should they animate in
        ...
        return this.each(function() {
            ...
            if(options.captions) {
            	if(navigator.appName=="Microsoft Internet Explorer")
               		 var captionHTML = '<div class="caption"  style="width:100%;background:transparent; filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000,endColorstr=#99000000);zoom: 1;"><span class="orbit-caption"></span></div>';
               	else
               		 var captionHTML = '<div class="caption"  style="width:100%;"><span class="orbit-caption"></span></div>';
